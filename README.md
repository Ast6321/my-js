...
today -- 17/02/2026
 ...
 after that i learned git and github from youtube chanel "apna college"
 after that i practiced git commands 
 and finaly created my repo my-js
 and currently i will working on it
...
<details title="click me">
<summary> Today's lesson (19/03/2026)</summary>
<pre>
time is a great healer 
it will heal all your wounds of soul
just keep patience and stay silent and calm.....
</pre>
...
today establish mongodb 
create a database 
make collection 
connect database with my server file 
add 2 documents manually on collection 
after that learn about schema and model
then proceed to api structure 
make get api for all users 
and a get api for specific user 
check and test the api on thunder client 
after that proceed to post 
still research is going on the post api 
tommarow will carry on to the post api 

i have create a repo learning mongo 
it have all the updates regarding the database learning 
